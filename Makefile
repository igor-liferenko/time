...
c:
	tie -c time.ch time.w control.ch txin.ch notification.ch design.ch mode.ch long-display.ch >/dev/null
	ctangle time time
	@make --no-print-directory time

k:
	tie -c time.ch time.w control.ch txin.ch notification.ch design.ch mode.ch reverse.ch >/dev/null
	ctangle time time
	@make --no-print-directory time

u:
	tie -c time.ch time.w control.ch txin.ch notification.ch design.ch mode.ch >/dev/null
	ctangle time time
	@make --no-print-directory time
